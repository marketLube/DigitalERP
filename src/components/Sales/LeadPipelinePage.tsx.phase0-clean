...
import { Search, Filter, Plus, Calendar, Users, Flag, Clock, CheckCircle, BarChart3, Eye, Edit3, Trash2, MoreHorizontal, MessageCircle, Mail, Phone, User, FileText, Settings, TrendingUp, ChevronLeft, ChevronRight, MapPin, LayoutGrid, List } from 'lucide-react';
...
const LeadPipelinePage: React.FC<LeadPipelinePageProps> = ({ defaultTab = 'pipeline' }) => {
  ...
  return (
    <div className="p-4 min-h-screen bg-white">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 text-sm mt-1">
              {activeTab === 'pipeline' ? 'Track and manage your sales opportunities' :
               activeTab === 'appointments' ? 'Schedule and manage client appointments' :
               activeTab === 'proposals' ? 'Manage and track your sales proposals' :
               activeTab === 'analytics' ? 'View sales performance and analytics' : 'Configure sales module settings'}
            </p>
          </div>
      ...
      {activeTab === 'pipeline' && (
        <>
          {/* Stats Dashboard - Smaller Cards */}
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
            <div className="bg-white p-4 rounded-lg border border-gray-200 shadow-sm">
              <div className="flex items-center gap-2 mb-1">
                <BarChart3 size={16} className="text-blue-600" />
                <span className="font-poppins font-medium text-gray-900 text-sm">Total Leads</span>
              </div>
              <p className="text-xl font-poppins font-semibold text-gray-900">{filteredLeads.length}</p>
            </div>

            <div className="bg-white p-4 rounded-lg border border-gray-200 shadow-sm">
              <div className="flex items-center gap-2 mb-1">
                <Flag size={16} className="text-green-600" />
                <span className="font-poppins font-medium text-gray-900 text-sm">Pipeline Value</span>
              </div>
            ...
            <div className="bg-white p-4 rounded-lg border border-gray-200 shadow-sm">
              <div className="flex items-center gap-2 mb-1">
                ...
                <span className="font-poppins font-medium text-gray-900 text-sm">Avg. Probability</span>
              </div>
              <p className="text-xl font-poppins font-semibold text-purple-600">{avgProbability}%</p>
            </div>

            <div className="bg-white p-4 rounded-lg border border-gray-200 shadow-sm">
              <div className="flex items-center gap-2 mb-1">
                <Clock size={16} className="text-orange-600" />
                <span className="font-poppins font-medium text-gray-900 text-sm">Hot Leads</span>
              </div>
              <p className="text-xl font-poppins font-semibold text-orange-600">
                {filteredLeads.filter(lead => lead.priority === 'Hot').length}
              </p>
            </div>
          </div>
